...
class TestGrafoAEstrela(unittest.TestCase):
    ...
    def test_astar_caminho_a_b_e_grafo_simples(self):
        ...
        dados_heuristica = [(a, b, round(heuristica, 2), real) for a, b, heuristica, real in dados_heuristica]
        ...
        self.assertEqual(dados_heuristica[1], ('A', 'B', 11.81, 7))
        ...
        self.assertIn('r:5.00+7.00 | h:5.00+6.81', descricao)  # A->B: real(5+7) | heurística(5+6)
        self.assertIn('r:7.00 | h:6.81', descricao)      # B->E: real(7) | heurística(6)
